...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   find_percentiles copy.c                            :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: bbonaldi <bbonaldi@student.42sp.org.br>    +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/09/15 17:24:32 by bbonaldi          #+#    #+#             */
/*   Updated: 2022/09/16 22:16:44 by bbonaldi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_unordered_percentile_count(t_push_swap *push_swap)
{
	...
	ft_set_unordered_count(&push_swap->stack_a.head_stack, &push_swap->first_quarter,
		push_swap->stack_a.min);
	ft_set_unordered_count(&push_swap->stack_a.head_stack, &push_swap->median,
		push_swap->first_quarter.value);
	ft_set_unordered_count(&push_swap->stack_a.head_stack, &push_swap->third_quarter,
...
void	ft_sort_auxiliary_list(t_push_swap *push_swap)
{
	...
	ft_fill_indexes(&push_swap->stack_ordered, &push_swap->stack_a);
}
